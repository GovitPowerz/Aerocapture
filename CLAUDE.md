...
src/rust/src/
  ...
  config.rs                        — TOML parser (Planet, MissionType, SimInput, IntegrationMode, AdaptiveConfig) + base inheritance (deep_merge, resolve_toml_bases, from_toml_file)
  data/
