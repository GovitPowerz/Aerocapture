...
- [Issue #80](https://github.com/GovitPowerz/Aerocapture/issues/80) and [issue #107](https://github.com/GovitPowerz/Aerocapture/issues/107): commissioned architecture reviews, each finding checked against the tree before it became an issue.
