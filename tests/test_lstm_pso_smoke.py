"""2-gen PSO training on a minimal LSTM config. Not a convergence test -- just
...
@pytest.mark.slow
def test_lstm_pso_smoke_2_gens(tmp_path: Path) -> None:
    ...
    save_dir = tmp_path / "neural_network_lstm_pso_smoke"
    ...
    sim_cfg = SimConfig(
        ...
        toml_config="configs/training/msr_aller_lstm_pso_train.toml",
        n_sims=2,
    )
