...
_CASES: list[tuple[_Disc, bool, _SM, bool]] = [
    ("euler", False, "real", False),
    ("euler", False, "complex", True),
    ("trapezoidal", True, "real", False),
    ("trapezoidal", True, "complex", True),
]
...
def test_mamba3_specs_length_matches_n_params() -> None:
    for disc, trap, sm, cplx in _CASES:
