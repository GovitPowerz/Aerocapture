...
| **CPAG** | Convex predictor-corrector (Rataczak/McMahon/Boyd 2025): SCP replan of a signed bank-rate profile via Clarabel QP, heat-flux/g-load/heat-load enforced in-loop, inclination in-loop (no lateral logic) | 12 | Self-contained; slowest (~3.5 s/sim); untuned already beats tuned FTC |
