...
| **CPAG** | Convex predictor-corrector (Rataczak/McMahon/Boyd 2025): SCP replan of a signed bank-rate profile via Clarabel QP, heat-flux/g-load/heat-load enforced in-loop, inclination in-loop (no lateral logic) | 12 | Self-contained; slowest (~3.5 s/sim); tuned: median parity with the classicals but loses the sizing tail (+84 m/s cvar95 paired — see `docs/plans/2026-07-19-cpag-c2-results.md`) |
