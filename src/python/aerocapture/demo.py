...
def run_demo(n_sims: int, output: Path) -> None:
    ...
    fig.suptitle("Aerocapture demo: Mamba-962 NN guidance, dispersed Mars Sample Return entry")
    fig.tight_layout()
...
def main() -> None:
    ...
    run_demo(args.n_sims, args.output)
