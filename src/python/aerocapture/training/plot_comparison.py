...
# Importing charts applies the seaborn theme module-wide
from aerocapture.training.charts import SCHEME_COLORS  # noqa: E402
...
def plot_comparison(results: dict[str, dict], output: Path) -> None:
    ...
    fig.suptitle("Guidance Scheme Comparison — Mars Aerocapture", fontsize=14, fontweight="bold")
    ...
    bars = ax.bar(x, capture_rates, color=colors, edgecolor="white", linewidth=0.5)
    ...
    ax.bar(x, costs, color=colors, edgecolor="white", linewidth=0.5)
