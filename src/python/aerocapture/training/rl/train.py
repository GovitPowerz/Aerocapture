    ...
    for spec in architecture:
        if isinstance(spec, _DS):
            ...
            raise NotImplementedError(
                "Window-MLP is PSO-only in Phase 2b; PPO use deferred. See docs/design/2026-04-20-phase-2b-window-mlp-design.md"
            )
        elif isinstance(spec, _TS):
            raise NotImplementedError(
                "Transformer is PSO-only in Phase 3a; PPO use deferred. See docs/design/2026-04-22-phase-3a-transformer-mvp-design.md"
            )
        else:
