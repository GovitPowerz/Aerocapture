...
- `build_layer` in `rl/layers/__init__.py` dispatches `MambaSpec` to **raise `NotImplementedError`** with message "Mamba is PSO-only in Phase 4a; PPO use deferred -- see docs/design/2026-04-24-phase-4a-mamba-ssm-mvp-design.md".
