...
c  temporaire
     ...
     +                + gainpd*(pdyneq - prenom)/pdyneq
      ...
      if (ncall.ge.36.and.ncall.le.46) then
         write(0,*) 'GUICAP[',ncall,']: E=',enrjlt/1.d6,
     +     ' vitrad=',vitrad,' pdyneq=',pdyneq,' rho=',roguid
         write(0,*) '  ref: cmunom=',cmunom,' prenom=',prenom,
     +     ' hdtnom=',hdtnom
         write(0,*) '  gains: gaindh=',gaindh,' gainpd=',gainpd,
     +     ' cz=',coefan(2),' alt=',altitu/1.d3
         write(0,*) '  cosmuc=',cosmuc,
     +     ' gitlon_pre=',gitlon/degrad
      endif
c
