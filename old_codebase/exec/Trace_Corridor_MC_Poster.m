...
plot(photo_nn_nom(:,1),photo_nn_nom(:,10),'r','LineWidth',1.5)
hold on;
%s = 'plot(';
...
%    s = [s 'photo_nn(' num2str(indices_deb(mm)) ':' num2str(indices_fin(mm)) ',1),photo_nn(' num2str(indices_deb(mm)) ':' num2str(indices_fin(mm)) ',10),''Color'',[255 204 0]/256,'];
    plot(photo_nn(indices_deb(mm):indices_fin(mm),1),photo_nn(indices_deb(mm):indices_fin(mm),10),'-','Color',[146 173 216]/256)
end
...
subplot(2,1,1)
set(gcf,'Color',[58 148 213]/256,'InvertHardCopy','off')
plot(photo_nn_nom(:,1),cos(photo_nn_nom(:,15)*pi/180),'r','LineWidth',1.5)
hold on;
%s = 'plot(';
for mm = 1:size(indices_deb,1)
    %s = [s 'photo_nn(' num2str(indices_deb(mm)) ':' num2str(indices_fin(mm)) ',1),photo_nn(' num2str(indices_deb(mm)) ':' num2str(indices_fin(mm)) ',15),''b-'','];
    plot(photo_nn(indices_deb(mm):indices_fin(mm),1),cos(photo_nn(indices_deb(mm):indices_fin(mm),15)*pi/180),'-','Color',[146 173 216]/256)
end
...
subplot(2,1,2)
set(gcf,'Color',[58 148 213]/256,'InvertHardCopy','off')
plot(photo_nn_nom(:,1),sin(photo_nn_nom(:,15)*pi/180),'r','LineWidth',1.5)
hold on;
%s = 'plot(';
for mm = 1:size(indices_deb,1)
    %s = [s 'photo_nn(' num2str(indices_deb(mm)) ':' num2str(indices_fin(mm)) ',1),photo_nn(' num2str(indices_deb(mm)) ':' num2str(indices_fin(mm)) ',15),''b-'','];
    plot(photo_nn(indices_deb(mm):indices_fin(mm),1),sin(photo_nn(indices_deb(mm):indices_fin(mm),15)*pi/180),'-','Color',[146 173 216]/256)
end
%s = [s 'photo_nn(' num2str(indices_deb(mm+1)) ':' num2str(indices_fin(mm+1)) ',1),photo_nn(' num2str(indices_deb(mm+1)) ':' num2str(indices_fin(mm+1)) ',15),''-'',''Color'',[146 173 216]/256);'];
%eval(s);
plot(photo_nn_nom(:,1),sin(photo_nn_nom(:,15)*pi/180),'r','LineWidth',1.5)
...
fill([visu_ovr(1,1);visu_ovr(:,1);visu_ovr(end,1)],[0;visu_ovr(:,2);0],[208 100 1]/256,'EdgeColor','k');
fill([5;5;visu_udr(1,1);visu_udr(:,1);visu_udr(end,1);-7;-7],[2.2;0;0;visu_udr(:,2);0;0;2.2],[208 100 1]/256,'EdgeColor','k');
for mm = 1:size(indices_deb,1)-1
    plot(photo_nn(indices_deb(mm):indices_fin(mm),19)/1000000,photo_nn(indices_deb(mm):indices_fin(mm),20)/1000,'-','Color',[146 173 216]/256);
end
plot(photo_nn_nom(:,19)/1000000,photo_nn_nom(:,20)/1000,'r','LineWidth',1.5)
